...
namespace ForAnimalsWithLove.Data.Migrations
{
    ...
    [Migration("20230813095038_NullableOptionsForUser")]
    partial class NullableOptionsForUser
    {
            ...
            modelBuilder.Entity("ForAnimalsWithLove.Data.Models.Operation", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 13, 9, 50, 38, 375, DateTimeKind.Utc).AddTicks(6632));
