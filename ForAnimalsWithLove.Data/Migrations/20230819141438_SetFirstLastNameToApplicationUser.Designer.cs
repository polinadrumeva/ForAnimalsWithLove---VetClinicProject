...
namespace ForAnimalsWithLove.Data.Migrations
{
    ...
    [Migration("20230819141438_SetFirstLastNameToApplicationUser")]
    partial class SetFirstLastNameToApplicationUser
    {
            ...
            modelBuilder.Entity("ForAnimalsWithLove.Data.Models.Operation", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 19, 14, 14, 38, 196, DateTimeKind.Utc).AddTicks(8167));
