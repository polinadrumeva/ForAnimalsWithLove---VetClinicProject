        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KindOfAnimal = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ...
                    HealthRecordId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnimalsBookings", x => new { x.AnimalId, x.BookingId });
                    table.ForeignKey(
                        name: "FK_AnimalsBookings_Animals_AnimalId",
                        column: x => x.AnimalId,
                        principalTable: "Animals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnimalsBookings_Bookings_BookingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondVaccine = table.Column<bool>(type: "bit", nullable: false),
                    ThirdVaccine = table.Column<bool>(type: "bit", nullable: false),
                    AnnualVaccine = table.Column<bool>(type: "bit", nullable: false),
                    GeneralCondition = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    PrescribedTreatment = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    HospitalRecordId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SearchHomes", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnimalsEducations", x => new { x.AnimalId, x.EducationId });
                    table.ForeignKey(
                        name: "FK_AnimalsEducations_Animals_AnimalId",
                        column: x => x.AnimalId,
                        principalTable: "Animals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnimalsEducations_Educations_EducationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 8, 31, 14, 21, 36, 833, DateTimeKind.Utc).AddTicks(2084)),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DoctorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tests_HospitalRecords_HospitalRecordId",
                        column: x => x.HospitalRecordId,
                        principalTable: "HospitalRecords",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnimalsBookings_BookingId",
                table: "AnimalsBookings",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_AnimalsEducations_EducationId",
                table: "AnimalsEducations",
                column: "EducationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Operations_HospitalRecordId",
                table: "Operations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tests_HospitalRecordId",
                table: "Tests",
                column: "HospitalRecordId");
