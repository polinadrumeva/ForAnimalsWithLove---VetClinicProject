...
namespace ForAnimalsWithLove.Data.Migrations
{
    ...
    [Migration("20230818113800_SetNullableToHealthRecord")]
    partial class SetNullableToHealthRecord
    {
            ...
            modelBuilder.Entity("ForAnimalsWithLove.Data.Models.Operation", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 18, 11, 38, 0, 337, DateTimeKind.Utc).AddTicks(1659));
